...
namespace DalamudBootAging
{
    public static class ProcessExtensions
    {
        ...
        {
            hwnd = p.GetWindowHandles().FirstOrDefault();
            if (hwnd != IntPtr.Zero)
        ...
        public static bool PostThreadMessage(this Process p, UInt32 msg, IntPtr wParam, IntPtr lParam,
            bool ensureTargetThreadHasWindow = true)
        {
